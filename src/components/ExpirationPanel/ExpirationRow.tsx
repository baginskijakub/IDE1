  ...
  return (
    <div className={'px-3 py-2 flex flex-col gap-1 bg-slate-100 rounded-md '}>
      <div className={'flex justify-between items-center'}>
        ...
        <div className={'w-[200px] text-right text-sm text-gray-600'}>{quantity}</div>
        <div className={'w-[200px] text-right text-sm text-gray-600'}>{expirationDate.toDateString()}</div>
      </div>
